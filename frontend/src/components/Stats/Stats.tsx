    ...
    <section id="stats" className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-[#3ecf8e] font-bold tracking-widest uppercase text-sm">Our Impact</h2>
          <h3 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">
            Proven Excellence in Education
          </h3>
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            We don't just teach; we empower. Our metrics show a consistent upward trajectory in
            student success and research output.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="grid grid-cols-1 gap-6">
            {[
              ...
              >
                <div className={`p-3 rounded-lg bg-gray-50 dark:bg-[#121212] ${item.color}`}>
                  <item.icon className="w-6 h-6" />
                </div>
                <div>
                  <h5 className="text-gray-900 dark:text-white font-bold">{item.title}</h5>
