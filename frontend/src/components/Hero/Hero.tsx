        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 dark:text-white leading-tight">
              Elevate Your <span className="text-[#3ecf8e]">Potential</span>, Connect Your Future.
            </h1>

            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-xl">
              Edunexus is a premier technology-driven university designed for the next generation of
              innovators, engineers, and digital artists.
            </p>
