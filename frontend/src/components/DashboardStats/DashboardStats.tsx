...
import { Users, BookOpen, Clock, GraduationCap, CalendarDays, AlertCircle } from "lucide-react";
    ...
    return (
      <>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl font-bold truncate">{data.nextClass || "No classes"}</div>
  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-xl font-bold truncate">{data.nextExam || "None"}</div>
          <p className="text-xs text-muted-foreground">{data.nextExamDate || "Keep studying!"}</p>
        </CardContent>
      </Card>
    </>
  );
