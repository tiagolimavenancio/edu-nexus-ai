...
import { type ClassFormValues, classFormSchema } from "@/schema/classesForm";
...
const ClassForm = ({ open, onOpenChange, initialData, onSuccess }: IClassFormProps) => {
  ...
  const onSubmit = async (data: ClassFormValues) => {
    try {
      const payload = {
        ...data,
        classTeacher:
          data.classTeacher === "unassigned" || data.classTeacher === "" ? null : data.classTeacher,
