...
import { formSchema, type FormValues } from "@/schema/academicForm";
import type { IAcademicYear } from "@/types/AcademicYear";

interface IAcademicYearFormProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  initialData: IAcademicYear | null;
  onSuccess: () => void;
}
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-106.25">
        <DialogHeader>
          <DialogTitle>{initialData ? "Edit Year" : "New Academic Year"}</DialogTitle>
          <DialogDescription>Set the duration for this session.</DialogDescription>
        </DialogHeader>
        {/* form */}
