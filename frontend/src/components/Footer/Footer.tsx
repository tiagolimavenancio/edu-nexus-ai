import { GraduationCap, Github, Twitter, Linkedin, ArrowUp } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 dark:text-gray-500 leading-relaxed">
              Redefining higher education through technology, innovation, and global connectivity.
              Join the frontier.
            </p>
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-bold mb-6 text-lg">Academics</h4>
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-bold mb-6 text-lg">Resources</h4>
            <ul className="space-y-4">
              <li>
                <a
                  href="#"
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-bold mb-6 text-lg">Newsletter</h4>
            <p className="text-gray-600 dark:text-gray-500 mb-6">
              Stay updated with the latest research breakthroughs and campus news.
            </p>
            <div className="flex">
              <input
                type="email"
