      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            ...
            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">Find Your Domain</h3>
          </div>
          <p className="text-gray-600 dark:text-gray-400 max-w-md">
            Our curriculum is designed in partnership with industry giants to ensure our graduates
            are day-one ready.
          </p>
        </div>
          ...
          {programs.map((program, idx) => (
            ...
            >
              <div className="absolute top-0 right-0 p-4 opacity-10 dark:opacity-5 transition-opacity group-hover:opacity-20 dark:group-hover:opacity-10">
                <program.icon size={80} className="text-gray-300 dark:text-white" />
              </div>
