...
interface IGeneratorControlsProps {
  isGenerating: boolean;
  selectedClass: string;
  onGenerate: (classId: string, yearId: string, settings: IGenSettings) => Promise<void>;
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const current = Array.isArray(yearRes.data)
          ? yearRes.data.find((y: IAcademicYear) => y.isCurrent)
          : yearRes.data;
    ...
    <Card className="w-full">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div>
            <CardTitle>{hideGenerate ? "View Timetable" : "Timetable Controls"}</CardTitle>
            <CardDescription>
              {hideGenerate
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select value={selectedYear} onValueChange={setSelectedYear} disabled={loadingData}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            <Label>Class</Label>
            <Select value={selectedClass} onValueChange={handleClassSelect} disabled={loadingData}>
              <SelectTrigger>
