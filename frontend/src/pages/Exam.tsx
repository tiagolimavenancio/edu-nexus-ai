  ...
  if ((!exam.isActive || isExpired) && !isTeacher) {
    return (
      <div className="h-[60vh] flex flex-col items-center justify-center text-center space-y-4">
        ...
        <p className="text-muted-foreground">This exam is currently closed or has expired.</p>
    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-4 text-muted-foreground text-sm">
          ...
          <div className="flex items-center gap-1">
            <Calendar className="h-4 w-4" /> Due: {new Date(exam.dueDate).toLocaleDateString()}
          </div>
        </div>
      </div>
      ...
      {isStudent && submission && (
        <>
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-8 space-y-4">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-5xl font-extrabold text-primary">{submission.score}</span>
          ...
          <div className="flex items-center gap-2">
            <Button variant="ghost" size="sm" onClick={() => navigate("/lms/quizzes")}>
      ...
      <div className="flex justify-end gap-4 pt-4">
        {isStudent && !submission && (
          <Button
            ...
            disabled={submitting}
          >
            {submitting ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : "Submit Exam"}
          </Button>
        )}
      </div>
    </div>
